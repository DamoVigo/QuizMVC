...
function () {
  ...
  _createClass(View, [{
    ...
    key: "clearView",
    value: function clearView(a) {
      a.style.display = "none";
    } ////// FONCTION DISPLAY BLOCK  /////////

  }, {
    key: "showView",
    value: function showView(a) {
    ...
    key: "flagToNameView",
    value: function flagToNameView(tirage, answers) {
      this.view = new View();
    ...
    key: "nameToCapitalView",
    value: function nameToCapitalView(tirage) {
      this.view = new View();
    ...
    key: "capitalToNameView",
    value: function capitalToNameView(tirage) {
      console.log(tirage);
      this.view = new View();
    ...
    key: "nameToFlagView",
    value: function nameToFlagView(tirage) {
      this.view = new View();
